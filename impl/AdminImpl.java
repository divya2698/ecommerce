 ...
 * </p>
 * <ul>
 *   <li>{@link Ecommerce.impl.AdminImpl#getDepartment <em>Department</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AdminImpl extends UserImpl implements Admin {
	...
	protected EClass eStaticClass() {
		return EcommercePackage.Literals.ADMIN;
	}
	...
	public void setDepartment(String newDepartment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcommercePackage.ADMIN__DEPARTMENT, oldDepartment, department));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcommercePackage.ADMIN__DEPARTMENT:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EcommercePackage.ADMIN___MANAGE_INVENTORY:
				manageInventory();
				return null;
			case EcommercePackage.ADMIN___GENERATE_REPORTS:
				generateReports();
				return null;
		}
